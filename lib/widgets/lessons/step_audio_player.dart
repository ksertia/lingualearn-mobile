...
class StepAudioPlayer extends StatefulWidget {
  ...
  const StepAudioPlayer({
    ...
    this.answerValue,
    this.stepIndex = 0,
    this.instruction = 'Écoutez attentivement',
  });

  @override
  State<StepAudioPlayer> createState() => _StepAudioPlayerState();
}

class _StepAudioPlayerState extends State<StepAudioPlayer>
